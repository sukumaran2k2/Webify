...
const PROJECTS = [
  ...
  },
  {
    ...
    category: 'Web App',
    desc: 'A CRUD-based dashboard for tracking job applications — add, update, and delete entries with status labels, company info, and notes. Clean, minimal UI focused on usability.',
    tech: ['React.js', 'JavaScript', 'REST API', 'LocalStorage'],
    emoji: '📊',
